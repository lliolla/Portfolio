...
<div className="contact-infos">
    ...
    <div className="phone">
        <div className="content">
            ...
            onClick={()=>alert("Téléphone copié!") }   >06 25 62 33 27</p> 
            </CopyToClipboard>
        </div>
    </div>
    <div className="email">
        <div className="content">
            ...
            <p style={{cursor : 'pointer'}} className="Clipboard" 
            onClick={()=>alert("Email copié!") }>fanny.jbt07@gmail.com</p>
            </CopyToClipboard>        
    ...
    <div className="credits">
        <p>Made with <span> <BsFillBalloonHeartFill/> </span>by Fanny Jobert - 2023</p>
